...
namespace EePulse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918084501_WP07Phase2B2IncidentRuntime")]
    partial class WP07Phase2B2IncidentRuntime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EePulse.Domain.Identity.HumanPrincipal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EePulse.Domain.Preferences.UserTimezonePreference", b =>
                {
                    b.Property<string>("Issuer")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                    ...
                    b.ToTable("user_timezone_preferences", null, t =>
                        {
                            t.HasCheckConstraint("ck_user_timezone_preferences_issuer", "char_length(issuer) BETWEEN 1 AND 512");

                            t.HasCheckConstraint("ck_user_timezone_preferences_subject", "char_length(subject) BETWEEN 1 AND 512");

                            t.HasCheckConstraint("ck_user_timezone_preferences_version", "version >= 1");
                        });
                });
            ...
            modelBuilder.Entity("EePulse.Domain.Status.IdempotencyReceipt", b =>
                {
                    ...
                    b.Property<Guid?>("IncidentCommentId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("IncidentLifecycleActionId")
                        .HasColumnType("uuid")
                        .HasColumnName("incident_lifecycle_action_id");
                    ...
                    b.Property<short>("RequestFingerprintVersion")
                        .HasColumnType("smallint")
                        .HasColumnName("request_fingerprint_version");
                    ...
                    b.HasKey("IdempotencyKey")
                        .HasName("pk_idempotency_receipts");

                    b.HasIndex("IncidentCommentId")
                        .IsUnique()
                        .HasDatabaseName("uq_idempotency_receipts_incident_comment");

                    b.HasIndex("IncidentLifecycleActionId")
                        .IsUnique()
                        .HasDatabaseName("uq_idempotency_receipts_lifecycle_action");

                    b.HasIndex("IdempotencyKey", "IncidentCommentId", "IncidentId", "ActorId");

                    b.HasIndex("IdempotencyKey", "IncidentLifecycleActionId", "IncidentId", "ActorId", "OutcomeKind");

                    b.ToTable("idempotency_receipts", null, t =>
                        {
            ...
            modelBuilder.Entity("EePulse.Domain.Status.IncidentComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_incident_comments");

                    b.HasAlternateKey("IdempotencyKey")
                        .HasName("uq_incident_comments_idempotency_key");

                    b.HasAlternateKey("IdempotencyKey", "Id", "IncidentId", "AuthorId")
            ...
            modelBuilder.Entity("EePulse.Domain.Status.IncidentLifecycleAction", b =>
                {
                    ...
                    b.HasKey("EventId")
                        .HasName("pk_incident_lifecycle_actions");

                    b.HasAlternateKey("IdempotencyKey")
                        .HasName("uq_incident_lifecycle_actions_idempotency_key");

                    b.HasAlternateKey("IdempotencyKey", "EventId", "IncidentId", "ActorId", "ActionKind")
                    ...
                    b.ToTable("incident_lifecycle_actions", null, t =>
                        {
            ...
            modelBuilder.Entity("EePulse.Domain.Status.AvailabilityIncident", b =>
                {
                    b.HasOne("EePulse.Domain.Identity.HumanPrincipal", null)
                        .WithMany()
                        .HasForeignKey("AcknowledgedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_availability_incidents_human_principals_acknowledged_by");
                    ...
                    b.HasOne("EePulse.Domain.Identity.HumanPrincipal", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_availability_incidents_human_principals_resolved_by");
                });

            modelBuilder.Entity("EePulse.Domain.Status.IdempotencyReceipt", b =>
                {
                    b.HasOne("EePulse.Domain.Status.IncidentComment", null)
                        .WithMany()
                        .HasForeignKey("IdempotencyKey", "IncidentCommentId", "IncidentId", "ActorId")
                        .HasPrincipalKey("IdempotencyKey", "Id", "IncidentId", "AuthorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_idempotency_receipts_incident_comment_outcome");

                    b.HasOne("EePulse.Domain.Status.IncidentLifecycleAction", null)
                        .WithMany()
                        .HasForeignKey("IdempotencyKey", "IncidentLifecycleActionId", "IncidentId", "ActorId", "OutcomeKind")
                        .HasPrincipalKey("IdempotencyKey", "EventId", "IncidentId", "ActorId", "ActionKind")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_idempotency_receipts_lifecycle_action_outcome");
                });
            ...
            modelBuilder.Entity("EePulse.Domain.Status.IncidentComment", b =>
                {
                    b.HasOne("EePulse.Domain.Identity.HumanPrincipal", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_incident_comments_human_principal");

                    b.HasOne("EePulse.Domain.Status.IdempotencyReceipt", null)
                        .WithMany()
                        .HasForeignKey("IdempotencyKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_incident_comments_idempotency_receipt");
                    ...
                    b.HasOne("EePulse.Domain.Status.AvailabilityIncident", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_incident_comments_availability_incident");
                });
            ...
            modelBuilder.Entity("EePulse.Domain.Status.IncidentLifecycleAction", b =>
                {
                    b.HasOne("EePulse.Domain.Identity.HumanPrincipal", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_incident_lifecycle_actions_human_principal");
                    ...
                    b.HasOne("EePulse.Domain.Status.IdempotencyReceipt", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_incident_lifecycle_actions_idempotency_receipt");
                    ...
                    b.HasOne("EePulse.Domain.Status.AvailabilityIncident", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_incident_lifecycle_actions_availability_incident");
                });
